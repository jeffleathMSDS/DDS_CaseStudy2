...
```{r compare Marital Status and Overtime with Attrition and Non Attition Employees}
library(sqldf)
df_ddanalytics = read.csv("Source/CaseStudy2-data.csv", header = TRUE)
...
plot1 <- ggplot(df_summary1, aes(MaritalStatus, name_count)) +  #
  geom_bar(stat = 'identity',fill="blue")+              # stat='identity' is used for summarized data.
  ggtitle("Attrition Maritial Status") +
  theme(plot.title = element_text(hjust = 0.5)) +
  xlab("Overtime") +
  ylab("Count")

plot2 <- ggplot(df_summary2, aes(MaritalStatus, name_count)) +  #
  geom_bar(stat = 'identity',fill="blue")+              # stat='identity' is used for summarized data.
...
df_summary4
## (1) Plot pre summarized data: 'df_summary'.
plot3 <- ggplot(df_summary3, aes(OverTime, name_count)) +  #
  geom_bar(stat = 'identity',fill="blue")+              # stat='identity' is used for summarized data.
...
plot4 <- ggplot(df_summary4, aes(OverTime, name_count)) +  #
  geom_bar(stat = 'identity',fill="blue")+              # stat='identity' is used for summarized data.
